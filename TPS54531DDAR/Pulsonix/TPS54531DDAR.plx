...
(library Library_1
	...
	(compDef "TPS54531DDAR" (originalName "TPS54531DDAR") (compHeader (numPins 9) (numParts 1) (refDesPrefix PS)
		...
		(compPin "5" (pinName "VSENSE") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps54531")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "TPS54531DDAR.stp")
