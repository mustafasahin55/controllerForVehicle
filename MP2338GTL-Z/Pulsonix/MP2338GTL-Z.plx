...
(library Library_1
	...
	(patternDef "MP2338GTLZ" (originalName "MP2338GTLZ")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.05 -0.6) (pt 1.05 -0.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.05 -0.6) (pt 1.05 0.6) (width 0.025))
		)
	...
	(compDef "MP2338GTL-Z" (originalName "MP2338GTL-Z") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(attr "<Hyperlink>" "https://www.monolithicpower.com/en/documentview/productdocument/index/version/2/document_type/Datasheet/lang/en/sku/MP2338GTL/document_id/9461/")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "MP2338GTL-Z.stp")
